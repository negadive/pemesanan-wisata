...
<body class="hold-transition sidebar-mini">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <p>
                    <div class="row">
                      <div class="col-6 text-center"><i class='fa fa-shopping-cart' aria-hidden='true'></i></i> Bayar</div>
                      <div class="col-6 text-center"><i class="fas fa-times text-danger" aria-hidden="true"></i> Batal Pesanan</div>
                    </div>
                  </p>
                      ...
                      foreach ($wahana_list as $data) {
                        if (($data["tgl_pemesanan"] > date("Y-m-d")) & (!isset($data["foto_bukti"]))) {
                          ...
                          <tr>
                            ...
                            <td onclick='hapusData(" . $data["tr_id"] . ")'><i class='fas fa-times text-danger' aria-hidden='true'></i></td>
                          </tr>
                        ";
                        }
                      }
  ...
  <script>
    ...
    function hapusData(id) {
      var result = confirm('Apa kamu yakin ingin membatalkan pesanan?')
      if (result) {
        window.location.href = "./act/transaksi.php?del=" + id
      }
    }
  </script>
</body>
